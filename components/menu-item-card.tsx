...
export function MenuItemCard({ item }: MenuItemProps) {
  ...
  return (
    <div className="rounded-2xl overflow-hidden shadow-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-900 dark:text-white hover:border-amber-500/50 transition-all duration-300 group hover:-translate-y-1 flex flex-col h-full">
      ...
      <div className="p-5 flex flex-col flex-grow bg-white dark:bg-slate-900">
        ...
        <div className="flex items-center justify-between mt-4 pt-4 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
          <div className="bg-gradient-to-r from-amber-500/10 to-amber-600/10 border border-amber-500/20 text-amber-600 dark:text-amber-400 font-bold px-4 py-1.5 rounded-full text-sm shadow-[0_0_10px_rgba(245,158,11,0.1)]">
            {item.price}
          </div>
